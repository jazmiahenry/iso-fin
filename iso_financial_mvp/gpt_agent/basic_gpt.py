"""
Basic GPT agent module that uses the standard GPT-4.1 model to provide financial advice
...
class BasicGPTAgent:
    """
    Financial agent using the standard GPT-4.1 model to provide financial analysis
    and calculations using the fin_tools toolkit.
    """
    
    def __init__(self, model_name: str = "gpt-4.1-2025-04-14"):
        """
        Initialize the basic GPT agent.
    ...
    def answer_question(
        ...
        """
        Process a financial query using the standard GPT-4.1 model with tool support.
        ...
        Use plain language that's accessible to non-experts, while maintaining accuracy.
        Explain financial concepts when they are relevant to the question.
